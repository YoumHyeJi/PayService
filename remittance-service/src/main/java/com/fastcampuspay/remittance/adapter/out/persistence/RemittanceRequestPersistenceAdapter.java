...
public class RemittanceRequestPersistenceAdapter implements RequestRemittancePort, FindRemittancePort {
    ...
    @Override
    public RemittanceRequestJpaEntity findRemittanceOne(CancelRemittanceCommand command) {
        return remittanceRequestRepository.findById(command.getRemittanceRequestId()).orElseThrow(
